...
function main() {
  ...
  const partnerNames = ['Sandra', 'Nicole', 'Julia', 'Kate', 'Natalie'];

  const locations = ['Amsterdam', 'Berlin', 'London', 'New York', 'Rome'];

  const jobTitles = ['doctor', 'pilot', 'designer', 'engineer', 'taxi driver'];
