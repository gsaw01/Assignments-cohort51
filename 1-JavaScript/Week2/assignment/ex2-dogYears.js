...
export function calculateDogAge(dogAgeInHumanYears) {
  const humanYearsToDogYears = dogAgeInHumanYears * 7;
  return `Your doggie is ${humanYearsToDogYears} years old in dog years!`;
}
